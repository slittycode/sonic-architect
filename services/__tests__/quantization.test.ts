...
describe('quantization', () => {
  it('returns notes unchanged when gridSize is off', () => {
    const notes: DetectedNote[] = [
      { midi: 60, name: 'C4', frequency: 261.63, startTime: 0.123, duration: 0.5, velocity: 100, confidence: 1 }
    ];
  ...
  it('snaps to the nearest 1/4 note boundary at 120 BPM', () => {
    ...
    const notes: DetectedNote[] = [
      { midi: 60, name: 'C4', frequency: 261.63, startTime: 0.49, duration: 0.51, velocity: 100, confidence: 1 },
      { midi: 62, name: 'D4', frequency: 293.66, startTime: 1.05, duration: 0.4, velocity: 100, confidence: 1 }
    ];
